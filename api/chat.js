...
module.exports = async (req, res) => {
  ...
  try {
    ...
    **절대 다른 직업(보안팀장, 의무병, 파일럿 등)을 지어내지 마십시오.**
    너는 오직 [항해사, 엔지니어, 의사, 시스템] 중 하나의 역할로만 대답할 수 있다.
    '보안팀장', '의무병', '파일럿' 같은 없는 직업은 절대 지어내지 마라.
    ...
    4. 배신자 설정: 3명의 NPC(항해사, 엔지니어, 의사) 중 1명은 배신자입니다. 미묘하게 거짓말을 하거나 이간질을 하십시오.
